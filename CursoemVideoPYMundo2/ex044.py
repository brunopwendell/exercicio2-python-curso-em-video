...
if pagamento == "CC":
    ...
    if vezes <= 2:
        parcela = valor / vezes
        print('''O valor final fica de R$ {:.2f},
         e as parcelas ficaram de {:.2f} no valor de R$ {}'''.format(valor, vezes, parcela))
    elif 2 < vezes <= 12:
        valor += valor * 0.20
        parcela = valor / vezes
        print('''O valor final de R$ {:.2f},
         e as parcelas ficaram de {}x 
         no valor de R$ {:.2f}'''.format(valor, vezes, parcela))
    else:
